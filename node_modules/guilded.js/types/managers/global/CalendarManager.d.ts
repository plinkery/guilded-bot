...
export declare class GlobalCalendarManager extends CacheableStructManager<number, CalendarEvent> {
     ...
     */
    create(channelId: string, options: OptionBody<CalendarEventsService["calendarEventCreate"]>): Promise<CalendarEvent>;
    /**
     ...
     */
    fetchMany(channelId: string, options: Omit<OptionQuery<CalendarEventsService["calendarEventReadMany"]>, "channelId">): Promise<Collection<number, CalendarEvent>>;
    /**
     ...
     */
    update(channelId: string, calendarEventId: number, options: OptionBody<CalendarEventsService["calendarEventUpdate"]>): Promise<CalendarEvent>;
    /**
     ...
     */
    updateRsvp(channelId: string, calendarEventId: number, userId: string, options: OptionBody<CalendarEventsService["calendarEventRsvpUpdate"]>): Promise<CalendarEventRsvp>;
    /**
     ...
     */
    updateManyRsvp(channelId: string, calendarEventId: number, options: OptionBody<CalendarEventsService["calendarEventRsvpUpdateMany"]>): Promise<void>;
    /**
